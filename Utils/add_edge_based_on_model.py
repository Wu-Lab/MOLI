...
#                     ER graph
################################################################################################################
ref_net = np.loadtxt('../Example_1_Simulated/ER_data/ER.txt')
add_edge_prop = 0.1
...
for x in ['x1', 'x2']:
    for loops in range(100):
        ...
        np.savetxt('../Example_1_Simulated/ER_data/add_edge/' + x + '_' +
...
################################################################################################################
# original net
ref_net = np.loadtxt('../Example_1_Simulated/BA_data/BA.txt')
add_edge_prop = 0.1
add_edge_num = int(np.ceil(add_edge_prop * ref_net.sum() / 2))
...
for x in ['x1', 'x2']:
    for loops in range(100):
        ...
        np.savetxt('../Example_1_Simulated/BA_data/add_edge/' + x + '_' +
                   str(loops) + '_addedge' + str(add_edge_prop) +
...
################################################################################################################
# original net
ref_net = np.loadtxt('../Example_1_Simulated/lesmis_data/lesmis.txt')
add_edge_prop = 0.1
add_edge_num = int(np.ceil(add_edge_prop * ref_net.sum() / 2))
...
for x in ['x1', 'x2']:
    for loops in range(100):
        ...
        np.savetxt('../Example_1_Simulated/lesmis_data/add_edge/' + x + '_' +
                   str(loops) + '_addedge' + str(add_edge_prop) +
...
################################################################################################################
# original net
G = nx.read_graphml('../Example_1_Simulated/cerebral_cortex_data/rhesus_cerebral.cortex_1.graphml')
...
for x in ['x1', 'x2']:
    for loops in range(100):
        ...
        np.savetxt('../Example_1_Simulated/cerebral_cortex_data/add_edge/' + x + '_' +
                   str(loops) + '_addedge' + str(add_edge_prop) +
